...
import (
	...
	clientset "kubevirt.io/kubevirt-dra-driver/pkg/kubevirt.io/resource/clientset/versioned"
)
...
func NewDriver(ctx context.Context, config *Config) (*driver, error) {
	...
	err := retry.RetryOnConflict(retry.DefaultRetry, func() error {
		...
		possibleDevices := enumerateAllPossibleDevices(supportedAllocatedDevices)
